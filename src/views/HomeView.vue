<template>
  <header class="container my-5">
    <h1 class="heading heading--primary">Pronóstico del Tiempo Ciudades de Chile</h1>

    <hr />

    <h2 class="heading heading--secondary">
      Este es extremadamente diverso debido a su larga geografía, albergando desde el desierto más
      árido del mundo en el norte (Atacama) hasta climas polares y glaciares en el extremo sur
      (Patagonia). Destacan el clima mediterráneo con veranos secos en el centro y un clima templado
      lluvioso en el sur.
    </h2>
  </header>
  ...
  <section class="container">
    ...
    />
    <p v-if="filtrados.length === 0" class="text-center">No se encontró la ciudad</p>
...
function agregarFavorito(lugar) {
  ...
  mensaje.value = `${lugar.nombre} agregada a favoritos`
...
//   alert(`${lugar.nombre} agregado a favoritos`)
// }

<template>
  <div class="container mt-4" v-if="lugar">
    <!-- <router-link to="/" class="btn btn-card mb-4">Volver </router-link> -->
...
function generarAlertas(stats) {
  ...
  if (stats.promedio > 30) a.push('Alerta de calor extremo')
  if (stats.conteo.Lluvioso >= 3) a.push('Semana muy lluviosa')
  if (stats.min < 0) a.push('Posibles heladas')
